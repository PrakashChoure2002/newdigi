...
const Footer = () => {
  ...
  return (
    <div className='w-full h-screen md:py-20'>
      <div className="raper w-full min-h-[98%] bg-zinc-800 md:flex gap-20 mb-6 py-10 px-5 md:px-32 relative">
        <div className="w-[100%] py-6 text-center md:w-[30%] h-[100%] ">
          <img className='ml-[25%] md:ml-10' src='/' alt="" />
        ...
        <div className="anker text-center py-6  w-[100%] md:w-[15%] h-[100%]  text-white ">
          <h1>MAIN MENU</h1>
          <a href="">Home</a>
          <a href="">Search</a>
        ...
        <div className="anker text-center py-6 w-[100%] md:w-[20%] h-[100%]  text-white">
          <h1>STORE INFO</h1>
        ...
        <div className="absolute right-6 bottom-10 p-4 bg-red-400 rounded-full  text-white"><a href=""><MdKeyboardDoubleArrowUp /></a></div>
      </div>
      <div className="ftr w-full py-2 px-10  text-white">
